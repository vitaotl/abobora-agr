...
<div class="container pt-1 pb-1">
	<div class="row align-items-center mb-3">
		<div class="col-sm-5 order-2 order-sm-1 pt-3">
			...
			<p class="text-primary" style="font-size: 14px;">Voc&ecirc; vai encontrar fornecedores de123 <B>
					...
					<div class="col-sm-12">
						<div class="row">
							<div class="col-6">
								...
								<a href="http://<?= $site->settings['buscamos_fornecedores_url'] . $foundPattern ?>" class="btn btn-primary btn-sm btn-block mt-2 mb-2"><?= $site->settings['buscamos_fornecedores_title'] ?></a>
