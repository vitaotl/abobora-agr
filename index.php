...
<div class="container pt-1 pb-1">
	<div class="row align-items-center mb-3">
		<div class="col-sm-5 order-2 order-sm-1 pt-3">
			...
			<p class="text-primary" style="font-size: 14px;">1Voc&ecirc; vai encontrar fornecedores de <B>
		...
		<div class="row m-0 p-0">
			...
			<div class="col-sm-4  order-2 order-sm-3 m-0 p-0" style="font-size: 13px;">
				...
				<p class="text-center">
					...
					<a href="https://www.linkedin.com/in/lincolncamargo" target="_blank" rel="noopener" style="color:#FF5722">https://www.linkedin.com/in/lincolncamargo</a>
					<br>
					<br>
					...
					<div class="col-sm-12">
						<div class="row">
							<div class="col-6">
								...
								<a href="<?= str_replace("https://www.", "http://", $site->settings['buscamos_fornecedores_url_site']) ?>" class="btn btn-primary btn-sm btn-block mt-2 mb-2"><?= $site->settings['buscamos_fornecedores_title'] ?></a>
							...
							<div class="col-6">
								...
								<a href="<?= str_replace("https://www.", "http://", $site->settings['safra_safrinha_url_site'])?>" class="btn btn-info btn-sm btn-block mt-2 mb-2"><?= $site->settings['safra_safrinha_title'] ?></a>
								<a href="https://agro.agr.br/safra"><img src="<?= $url ?>/assets/img/Comprador-Agro.jpg" alt="Agro Agr" class="img-fluid mb-3"></a>
